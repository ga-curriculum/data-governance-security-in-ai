...
1. **Create a Directory**
   - On your machine, create a directory or folder named `data-governance-security-in-ai` where you can save all the data and the jupyter notebooks concerned with this module.
...
4. **Create a New Jupyter Notebook**  
   ...
   - Rename the notebook by clicking on the **default name ("Untitled")** and entering the name as:  
     ```
     <DATA_GOVERNANCE_SECURITY_IN_AI>.ipynb
     ```
